...
public class Day {
    ...
    /*
     * 08-14 09:30:32.554: E/startDay(16367): 2457144
     */
        ...
        protected Void doInBackground(Void... params) {
            Cursor c = context.getContentResolver().query(
                    ...
                    new String[]{CalendarProvider.ID, CalendarProvider.EVENT,
                            ...
                            CalendarProvider.DATEE,
                            CalendarProvider.CALENDAR_ID,
            ...
            if (c != null) {
                if (c.moveToFirst()) {
                    do {
                        ...
                        event.setDate(c.getString(7));
                        event.setCalendar_id(c.getString(8));
                        event.setType(c.getString(9));
