...
public class CalendarProvider extends ContentProvider {
    ...
    private static final String AUTHORITY = "com.calendar.extendedcalendarview.calendarprovider";
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            Log.w("CalendarProvider", "Upgrading database from version "
        ...
        private void createTables(SQLiteDatabase db) {
            db.execSQL("CREATE TABLE " + EVENTS_TABLE + "(" + ID
                    ...
                    + " TEXT, " + START + " INTEGER, " + END + " INTEGER, "
                    + START_DAY + " INTEGER, " + END_DAY + " INTEGER, " + DATEE
                    + " TEXT, "
                    + CALENDAR_ID + " TEXT, " + COLOR
                    + " INTEGER);");
        }
    }
